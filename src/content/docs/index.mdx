...
import Colby from "../../assets/Colby.png";
import Frank from "../../assets/Frank.png";
import Jake from "../../assets/Jake.png";
import Jeff from "../../assets/Jeff.png";
import RobHess from "../../assets/RobHess.png";
import JonRehoorn from "../../assets/JonReehoorn.png";
...
<CardGrid>
  <ImgCard title="Artem Kolpakov">
    <Image src={Artem} alt="Artem Kolpakov" size="1.333em" />
    artemkolpakov78@gmail.com
  </ImgCard>
  <ImgCard title="Andy James">
    <Image src={Andy} alt="Andy James" size="1.333em" />
    andy.matthew.james@gmail.com
  </ImgCard>
  <ImgCard title="Colby Hannan">
    <Image src={Colby} alt="Colby Hannan" size="1.333em" />
    Colbyjh101@gmail.com
  </ImgCard>
  <ImgCard title="Frank Nguyen">
    <Image src={Frank} alt="Frank Nguyen" size="1.333em" />
    baoanhtdn@gmail.com
  </ImgCard>
  <ImgCard title="Jake Gehrke">
    <Image src={Jake} alt="Jake Gehrke" size="1.333em" />
    jake.d.gehrke@gmail.com
  </ImgCard>
  <ImgCard title="Jeff Huang">
    <Image src={Jeff} alt="Jeff Huang" size="1.333em" />
    huangjeff.cs@gmail.com
  </ImgCard>
</CardGrid>
...
<CardGrid>
  <ImgCard title="Jon Rehoorn">
    <Image src={JonRehoorn} alt="Jon Rehoorn" size="1.333em" />
    OSU Men's Golf Coach
  </ImgCard>
  <ImgCard title="Rob Hess">
    <Image src={RobHess} alt="Rob Hess" size="1.333em" />
